  ...
  async componentDidMount() {
    if (
      ...
      if (provincesRes && provincesRes.errCode === 0) {
        ...
        this.getClinicDetailById(this.state.currentClinicId);
      }
    }
  }

  getClinicDetailById = async (clinicId, location) => {
    let res = await handleGetClinicDetailByIdService(clinicId);
    if (res && res.errCode === 0) {
      let copyState = { ...this.state };
      copyState.descriptionHTML = res.data.descriptionHTML;
      copyState.descriptionMarkdown = res.data.descriptionMarkdown;
      copyState.listDoctor = res.data.clinicDoctors;
      console.log(res.data.clinicDoctors);
            ...
            <div className="specialty-doctors-container">
              ...
              {listDoctor &&
                ...
                listDoctor.map((item, index) => {
                  return (
                    <div className="specialty-doctor-container">
